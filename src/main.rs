...
fn main() {
    let app = App::new("git-series")
        ...
        .subcommand(SubCommand::with_name("add")
            ...
            .arg_from_usage(r#"<change>... 'Changes to add ("series", "base", "cover")'"#),
        ...
        ).subcommand(SubCommand::with_name("cover")
            ...
            .arg(Arg::with_name("source_dest")
                ...
                .min_values(1)
                .max_values(2)
                .help("source (default: current series) and destination (required)")
            ),
            ...
            .arg_from_usage(r#"--no-from 'Don't include in-body "From:" headers when formatting patches authored by others'"#)
